...
TEXT_EN = {
    ...
    "Transcription_started_lang_warn": "Automatic translation to English not possible for experimental model, please choose another one. Transcription was started without translation.",
...
TEXT_DE = {
    ...
    "Setting_fast": "Schnell, wenig präzise",
    "Setting_medium":"Mittlere Geschwindigkeit und Präzision",
    "Setting_slow":"Langsam, hohe Präzision",
    "Setting_very_slow":"Sehr langsam, sehr hohe Präzision",
    "Setting_turbo": "Schnell und präzise, experimentell",
    ...
    "Transcription_started_lang_warn": "Automatisches Übersetzen auf Englisch für experimentelles Modell nicht möglich, bitte suche dir ein anderes aus. Transkription wurde ohne Übersetzung gestartet.",
